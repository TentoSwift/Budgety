...
enum CategoryDefaults {
    ...
    static let expenseSeeds: [CategorySeed] = [
        .init(name: String(localized: "食費"), colorHex: "#FF9500", symbol: "fork.knife"),
        .init(name: String(localized: "交通"), colorHex: "#5B8DEF", symbol: "car.fill"),
        .init(name: String(localized: "住居"), colorHex: "#A2845E", symbol: "house.fill"),
        .init(name: String(localized: "光熱費"), colorHex: "#FFCC00", symbol: "bolt.fill"),
        .init(name: String(localized: "娯楽"), colorHex: "#FF2D55", symbol: "gamecontroller.fill"),
        .init(name: String(localized: "買い物"), colorHex: "#AF52DE", symbol: "cart.fill"),
        .init(name: String(localized: "医療"), colorHex: "#FF3B30", symbol: "cross.case.fill"),
        .init(name: String(localized: "教育"), colorHex: "#5856D6", symbol: "book.fill"),
        .init(name: String(localized: "旅行"), colorHex: "#5AC8FA", symbol: "airplane"),
        .init(name: String(localized: "その他"), colorHex: "#8E8E93", symbol: "ellipsis.circle.fill")
    ]

    /// 収入カテゴリ
    static let incomeSeeds: [CategorySeed] = [
        .init(name: String(localized: "給料"), colorHex: "#34C759", symbol: "briefcase.fill", kind: .income),
        .init(name: String(localized: "ボーナス"), colorHex: "#30B0C7", symbol: "gift.fill", kind: .income),
        .init(name: String(localized: "副業"), colorHex: "#FF9500", symbol: "hammer.fill", kind: .income),
        .init(name: String(localized: "投資"), colorHex: "#5856D6", symbol: "chart.line.uptrend.xyaxis", kind: .income),
        .init(name: String(localized: "その他収入"), colorHex: "#8E8E93", symbol: "plus.circle.fill", kind: .income)
    ]
